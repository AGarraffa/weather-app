...
const countryData = [
    {name: 'Country', alpha2: '', countryCode: ''},
...
// hides the state menu if not in the US. 
...
submitBtn.addEventListener("click", function(event) {
  ...
  function getWeather(x, y) {
    ...
    // let weatherUrl = 'http://api.openweathermap.org/data/2.5/onecall?lat=39.7546349&lon=-105.2205809&exclude=minutely,hourly&units=imperial&appid=e1eb99be58f229feb0f00b803ac936d3'
